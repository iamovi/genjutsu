...
// Example: https://genjutsu-config.oviren-human.workers.dev/config
const WORKER_URL = import.meta.env.VITE_CONFIG_WORKER_URL || "https://genjutsu-config.oviren-human.workers.dev/config";
